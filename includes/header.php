                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <?php } ?>
                            <li><a href="results.php<?php echo ((!empty($_GET['week'])) ? '?week=' . (int)$_GET['week'] : ''); ?>">Weekly Results</a></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="nflnews.php">NFL News</a></li>
                                    <li><a href="teams.php">NFL Team Schedules</a></li>
                                </ul>
                            </li>
